# ระบบบันทึกข้อมูลเกียรติบัตร

เป็นระบบสำหรับร้านรับซ่อมทั่วไป เช่น ร้านซ่อมมือถือ ร้านซ่อมเครื่องใช้ไฟฟ้า หรือแม้แต่ร้านซ่อมรถ ตัวระบบสามารออก (สั่งพิมพ์) ใบรับซ่อมได้ แจ้งเตือนไปยังคุณครูผ่านไลน์ เมื่อมีการทำรายการใหม่
และลูกค้าสามารถติดตามกิจกรรมได้ด้วยตัวเองผ่าน QRCode บนมือถือ สามารถมีคุณครูได้หลายคน
...
- เข้าระบบเป็นคุณครู : `demo@localhost` และ Password : `demo`
- เข้าระบบเป็นคุณครู : `demo2@localhost` และ Password : `demo`
